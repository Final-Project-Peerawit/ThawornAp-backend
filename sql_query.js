...
const SELECT_PLACE = fs.readFileSync("./src/sql_tables/SELECT_PLACE.sql").toString();

const SELECT_ITEM_REPAIR = fs
  .readFileSync("./src/sql_tables/SELECT_ITEM_REPAIR.sql")
  .toString();

const SELECT_BRANCH = fs.readFileSync("./src/sql_tables/SELECT_BRANCH.sql").toString();

const THAWORN_ROLE = fs.readFileSync("./src/sql_tables/THAWORN_ROLE.sql").toString();

const FUNCTION_LIST = fs.readFileSync("./src/sql_tables/FUNCTION_LIST.sql").toString();

const ROLE_LIST = fs.readFileSync("./src/sql_tables/ROLE_LIST.sql").toString();

const USER_INFO = fs.readFileSync("./src/sql_tables/USER_INFO.sql").toString();

const REPORT_STATE = fs.readFileSync("./src/sql_tables/REPORT_STATE.sql").toString();
